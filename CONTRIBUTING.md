...
- See if your issue or idea has [already been reported](https://github.com/plughacker/plug-checkout/issues).
...
1. To begin: [fork this project](https://github.com/plughacker/plug-checkout/fork), clone your fork, and add our upstream.

   ```bash
   # Clone your fork of the repo into the current directory
   git clone git@github.com:$(npx github-username-cli $(git config user.email))/plug-checkout.git

   # Navigate to the newly cloned directory
   cd plug-checkout

   # Assign the original repo to a remote called "upstream"
   git remote add upstream git@github.com:plughacker/plug-checkout.git
