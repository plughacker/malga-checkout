...
| `dialogConfig`      | --                |             | `PlugCheckoutFullDialog`                                                | `{     show: true,   }`                                                                                                                                                         |
...
| `pageConfig`        | --                |             | `PlugCheckoutFullPage`                                                  | `{     brandUrl: '',     footerDescription: '',     backRoute: '',     delivery: 0,     products: [],     internationalCustomer: false,   }`                                    |
