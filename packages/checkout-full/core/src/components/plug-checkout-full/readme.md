...
| `dialogConfig`      | --            |             | `PlugCheckoutFullDialog`         | `{     show: true,     actionButtonLabel: 'Continuar',     successActionButtonLabel: 'Continuar',     errorActionButtonLabel: 'Tentar Novamente',   }` |
| `merchantId`        | `merchant-id` |             | `string`                         | `undefined`                                                                                                                                            |
| `pageConfig`        | --            |             | `PlugCheckoutFullPage`           | `{     brandUrl: '',     footerDescription: '',     delivery: 0,     products: [],   }`                                                                |
...
| ----------------- | ----------- | ------------------------------------------------------- |
| `checkoutFailed`  |             | `CustomEvent<{ error: PlugCheckoutFullChargeError; }>`  |
| `checkoutSuccess` |             | `CustomEvent<{ data: PlugCheckoutFullChargeSuccess; }>` |
