...
const getComponentClasses = (classes: string) => {
...
const getElementClasses = (
  ...
  return [
    ...Array.from(ref.value ? ref.value.classList : []),
    ...defaultClasses,
  ].filter(
...
export const defineContainer = <Props>(
  ...
  const Container = defineComponent<Props & InputProps>(
    (props: any, { attrs, slots, emit }) => {
      ...
      const classes = new Set(getComponentClasses(attrs.class as string))
        ...
        if (vnode.el) {
          ...
          eventsNames.forEach((eventName: string) => {
            vnode.el.addEventListener(eventName.toLowerCase(), (e: Event) => {
              modelPropValue = e && (e.target as any)[modelProp]
      ...
      const hasRouter =
        ...
        currentInstance.appContext.provides[NAV_MANAGER]
      ...
      return () => {
        ...
        getComponentClasses(attrs.class as string).forEach((value) => {
          classes.add(value)
        })
