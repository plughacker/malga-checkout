...
declare global {
  ...
  interface HTMLMalgaPaymentsNupayElement
    extends Components.MalgaPaymentsNupay,
      HTMLStencilElement {}
  var HTMLMalgaPaymentsNupayElement: {
    prototype: HTMLMalgaPaymentsNupayElement
    new (): HTMLMalgaPaymentsNupayElement
  }
  interface HTMLMalgaPaymentsNupayContentElement
    extends Components.MalgaPaymentsNupayContent,
      HTMLStencilElement {}
  ...
  interface HTMLMalgaPaymentsNupayIframeElement
    extends Components.MalgaPaymentsNupayIframe,
      HTMLStencilElement {}
  ...
  interface HTMLMalgaPaymentsDripElement
    extends Components.MalgaPaymentsDrip,
      HTMLStencilElement {}
  var HTMLMalgaPaymentsDripElement: {
    prototype: HTMLMalgaPaymentsDripElement
    new (): HTMLMalgaPaymentsDripElement
  }
  interface HTMLMalgaPaymentsDripContentElement
    extends Components.MalgaPaymentsDripContent,
      HTMLStencilElement {}
  ...
  interface HTMLMalgaPaymentsDripIframeElement
    extends Components.MalgaPaymentsDripIframe,
      HTMLStencilElement {}
  var HTMLMalgaPaymentsDripIframeElement: {
    prototype: HTMLMalgaPaymentsDripIframeElement
    new (): HTMLMalgaPaymentsDripIframeElement
  }
  interface HTMLMalgaPaymentsDripInstallmentsElement
    extends Components.MalgaPaymentsDripInstallments,
      HTMLStencilElement {}
  ...
  interface HTMLMalgaPaymentsPixElement
    extends Components.MalgaPaymentsPix,
      HTMLStencilElement {}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      'malga-checkout': LocalJSX.MalgaCheckout &
        JSXBase.HTMLAttributes<HTMLMalgaCheckoutElement>
      'malga-payments': LocalJSX.MalgaPayments &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsElement>
      'malga-payments-boleto': LocalJSX.MalgaPaymentsBoleto &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsBoletoElement>
      'malga-payments-credit': LocalJSX.MalgaPaymentsCredit &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsCreditElement>
      'malga-payments-credit-form': LocalJSX.MalgaPaymentsCreditForm &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsCreditFormElement>
      'malga-payments-credit-saved-cards': LocalJSX.MalgaPaymentsCreditSavedCards &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsCreditSavedCardsElement>
      'malga-payments-nupay': LocalJSX.MalgaPaymentsNupay &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsNupayElement>
      'malga-payments-nupay-content': LocalJSX.MalgaPaymentsNupayContent &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsNupayContentElement>
      'malga-payments-nupay-iframe': LocalJSX.MalgaPaymentsNupayIframe &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsNupayIframeElement>
      'malga-payments-drip': LocalJSX.MalgaPaymentsDrip &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsDripElement>
      'malga-payments-drip-content': LocalJSX.MalgaPaymentsDripContent &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsDripContentElement>
      'malga-payments-drip-iframe': LocalJSX.MalgaPaymentsDripIframe &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsDripIframeElement>
      'malga-payments-drip-installments': LocalJSX.MalgaPaymentsDripInstallments &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsDripInstallmentsElement>
      'malga-payments-pix': LocalJSX.MalgaPaymentsPix &
        JSXBase.HTMLAttributes<HTMLMalgaPaymentsPixElement>
    }
  }
}
