...
| `:publicKey.prop`              | Public key for client-side applications, generated from Plug’s API. [Click here](https://docs.malga.io/#section/Autenticacao/Client-Token) to read more about it in the documentation. | `string`   | `undefined`                   |
| `:capture.prop`                | It determines if the transaction should be captured immediately.                                                                                                                       | `boolean`  | `false`                       |
| `:clientId.prop`               | Key to identify the client on Plug. [Click here](https://docs.malga.io/#section/Get-started/Configure-uma-conta-Plug) to read more about it in the documentation.                      | `string`   | `undefined`                   |
...
| `:merchantId.prop`             | Subaccounts identifier on Plug. [Click here](https://docs.malga.io/#tag/Merchants) to read more about it in the documentation.                                                         | `string`   | `undefined`                   |
