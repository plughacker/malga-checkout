...
| `startIcon`            | `start-icon`             |             | `"arrowDown" \| "arrowLeft" \| "calendar" \| "check" \| "checkLarge" \| "clipboard" \| "creditCard" \| "cvv" \| "dollar" \| "edit" \| "error" \| "eye" \| "eyeSlash" \| "lock" \| "pix" \| "poweredByPlug" \| "spinner" \| "user" \| "warning"` | `undefined` |
